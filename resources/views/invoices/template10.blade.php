                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c="" style="max-width: 200px;" class="d-logo" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-blue.png'))}}@endif"></div>
                                </div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('From')}}:</strong>
                                        <p data-v-b8f60a0c="">@if($currentWorkspace->company){{$currentWorkspace->company}}@endif</p>
                                        <pre data-v-b8f60a0c="">@if($currentWorkspace->address){{$currentWorkspace->address}}@endif</pre>
                                        <p data-v-b8f60a0c="">@if($currentWorkspace->city) {{$currentWorkspace->city}}, @endif @if($currentWorkspace->state){{$currentWorkspace->state}}@endif @if($currentWorkspace->zipcode)- {{$currentWorkspace->zipcode}}@endif</p>
                                        <p data-v-b8f60a0c="">@if($currentWorkspace->country){{$currentWorkspace->country}}@endif</p>
                                        <p data-v-b8f60a0c="">@if($currentWorkspace->telephone){{$currentWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-2">
                                        <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('To')}}:</strong>
                                            @if($invoice->client)                                                <p data-v-b8f60a0c="">{{$invoice->client->name}}</p>
                                ...
                                <div data-v-b8f60a0c="" class="d-table">
                                    <div data-v-b8f60a0c="" class="d-table">
                                        <div data-v-b8f60a0c="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-th w-17">{{__('Item')}}</div>
                                            <div data-v-b8f60a0c="" class="d-table-th w-5 text-right">{{__('Totals')}}</div>
                                        </div>
                                        <div data-v-b8f60a0c="" class="d-table-body">
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-b8f60a0c="" class="d-table-tr">
                                                        <div data-v-b8f60a0c="" class="d-table-td w-2"><span>{{$key+1}}</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-17">
                                                            <pre data-v-b8f60a0c="">{{$item->task->title}}</pre>
                                                        </div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-5 text-right"><span data-v-b8f60a0c="">{{$currentWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-b8f60a0c="" class="d-table-footer">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-summary">
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                        <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-b8f60a0c="" class="d-table-value">- {{$currentWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                        <div data-v-b8f60a0c="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-b8f60a0c="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-b8f60a0c="" class="d-table-summary-item" style="color: {{$font_color}}; background: {{$color}};">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
