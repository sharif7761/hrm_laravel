                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('INVOICE')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{Utility::invoiceNumberFormat($invoice->invoice_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{Utility::dateFormat($invoice->issue_date)}}</p>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-1"><img data-v-7d9d14b5="" class="d-logo" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-blue.png'))}}@endif" style="max-width: 150px;"></div>
                                </div>
                                <div data-v-7d9d14b5="" class="break-50"></div>
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <h3 data-v-7d9d14b5="" class="sub-title">@if($currentWorkspace->company){{$currentWorkspace->company}}@endif</h3>
                                        <pre data-v-7d9d14b5="">@if($currentWorkspace->address){{$currentWorkspace->address}}@endif</pre>
                                        <p data-v-7d9d14b5="">@if($currentWorkspace->city) {{$currentWorkspace->city}}, @endif @if($currentWorkspace->state){{$currentWorkspace->state}}@endif @if($currentWorkspace->zipcode)- {{$currentWorkspace->zipcode}}@endif</p>
                                        <p data-v-7d9d14b5="">@if($currentWorkspace->country){{$currentWorkspace->country}}@endif</p>
                                        <p data-v-7d9d14b5="">@if($currentWorkspace->telephone){{$currentWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <div data-v-7d9d14b5="" class="padd"><strong data-v-7d9d14b5="" class="mb5">{{__('To')}}:</strong>
                                            <p data-v-7d9d14b5="">{{$invoice->client->name}}</p>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Project')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{$invoice->project->name}}</td>
                                            </tr>
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-7d9d14b5="" class="d-table">
                                    <div data-v-7d9d14b5="" class="d-table">
                                        <div data-v-7d9d14b5="" class="tu d-table-tr" style="color: {{$font_color}}; background: {{$color}};">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-th w-17" style="padding: 3px;">{{__('Item')}}</div>
                                            <div data-v-7d9d14b5="" class="d-table-th w-5 text-right" style="padding: 3px;">{{__('Totals')}}</div>
                                        </div>
                                            ...
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        <div data-v-7d9d14b5="" class="d-table-td w-2" style="padding: 3px;"><span>{{$key+1}}</span></div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-17" style="padding: 3px;">
                                                            <pre data-v-7d9d14b5="">{{$item->task->title}}</pre>
                                                        </div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-5 text-right" style="padding: 3px;"><span data-v-7d9d14b5="">{{$currentWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-7d9d14b5="" class="d-table-footer">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-summary">
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">- {{$currentWorkspace->priceFormat($invoice->discount)}}</div>
                                                </div>
                                                @endif
                                                @if($invoice->tax)
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                </div>
                                                @endif
                                                <div data-v-7d9d14b5="" class="d-table-summary-item" style="background: {{$color}}; color: {{$font_color}};">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
