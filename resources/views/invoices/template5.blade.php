                            ...
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <img data-v-e23d9750="" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-blue.png'))}}@endif" class="d-logo">
                                        <div data-v-e23d9750="" class="break-25"></div>
                                        <p data-v-e23d9750="">@if($currentWorkspace->company){{$currentWorkspace->company}}@endif</p>
                                        <pre data-v-e23d9750="">@if($currentWorkspace->address){{$currentWorkspace->address}}@endif</pre>
                                        <p data-v-e23d9750="">@if($currentWorkspace->city) {{$currentWorkspace->city}}, @endif @if($currentWorkspace->state){{$currentWorkspace->state}}@endif @if($currentWorkspace->zipcode)- {{$currentWorkspace->zipcode}}@endif</p>
                                        <p data-v-e23d9750="">@if($currentWorkspace->country){{$currentWorkspace->country}}@endif</p>
                                        <p data-v-e23d9750="">@if($currentWorkspace->telephone){{$currentWorkspace->telephone}}@endif</p>
                                    </div>
                                </div>
                                        ...
                                        <div data-v-e23d9750="" class="d-table-footer">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-summary">
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-e23d9750="" class="d-table-value">- {{$currentWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-e23d9750="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="fwb f-b tu d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-e23d9750="" class="fwb f-b d-table-value">{{$currentWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
