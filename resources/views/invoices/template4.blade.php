                            ...
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-3">
                                        <h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('INVOICE')}}</h1>
                                        <p data-v-363339a0="">@if($currentWorkspace->company){{$currentWorkspace->company}}@endif</p>
                                        <pre data-v-363339a0="">@if($currentWorkspace->address){{$currentWorkspace->address}}@endif</pre>
                                        <p data-v-363339a0="">@if($currentWorkspace->city) {{$currentWorkspace->city}}, @endif @if($currentWorkspace->state){{$currentWorkspace->state}}@endif @if($currentWorkspace->zipcode)- {{$currentWorkspace->zipcode}}@endif</p>
                                        <p data-v-363339a0="">@if($currentWorkspace->country){{$currentWorkspace->country}}@endif</p>
                                        <p data-v-363339a0="">@if($currentWorkspace->telephone){{$currentWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-363339a0="" class="col-1">
                                        <img data-v-363339a0="" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-blue.png'))}}@endif" style="max-width: 150px" class="d-logo">
                                    </div>
                                </div>
                                <div data-v-363339a0="" class="break-50"></div>
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-66">
                                        <strong data-v-363339a0="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Bill To')}}:</strong>
                                        @if($invoice->client)
                                            <p data-v-363339a0="">{{$invoice->client->name}}</p>
                                    ...
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Project')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{$invoice->project->name}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 2px solid {{$color}}; border-top: 2px solid {{$color}};">
                                            <div data-v-363339a0="" class="d-table-th w-2">{{__('#')}}</div>
                                            <div data-v-363339a0="" class="d-table-th w-17">{{__('Item')}}</div>
                                            <div data-v-363339a0="" class="d-table-th w-5 text-right">{{__('Totals')}}</div>
                                        </div>
                                        <div data-v-363339a0="" class="d-table-body">
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        <div data-v-363339a0="" class="d-table-td w-2"><span>{{$key+1}}</span></div>
                                                        <div data-v-363339a0="" class="d-table-td w-17">
                                                            <pre data-v-363339a0="">{{$item->task->title}}</pre>
                                                        </div>
                                                        <div data-v-363339a0="" class="d-table-td w-5 text-right"><span data-v-e95a8a8c="">{{$currentWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-363339a0="" class="d-table-footer">
                                            ...
                                            <div data-v-363339a0="" class="d-table-summary">
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="tu d-table-label">{{__('Sub Total')}}:</div>
                                                    <div data-v-363339a0="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-363339a0="" class="d-table-value">- {{$currentWorkspace->priceFormat($invoice->discount)}}</div>
                                                    </div>
                                                @endif
                                                @if($invoice->tax)
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-363339a0="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-363339a0="" class="d-table-summary-item">
                                                    <div data-v-363339a0="" class="fwb f-b tu d-table-label" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Total')}}:</div>
                                                    <div data-v-363339a0="" class="fwb f-b d-table-value" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{$currentWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div data-v-363339a0="" class="break-50"></div>
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-66"><p data-v-363339a0="" class="thank" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Thank you')}}!</p></div>
