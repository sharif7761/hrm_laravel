            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-136bf9b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-66">
                                        <img data-v-136bf9b5="" src="@if($currentWorkspace->logo){{asset(Storage::url('logo/'.$currentWorkspace->logo))}}@else{{asset(Storage::url('logo/logo-blue.png'))}}@endif" class="d-logo" style="max-width: 200px;">
                                        <h3 data-v-136bf9b5="">@if($currentWorkspace->company){{$currentWorkspace->company}}@endif</h3>
                                        <pre data-v-136bf9b5="">@if($currentWorkspace->address){{$currentWorkspace->address}}@endif</pre>
                                        <p data-v-136bf9b5="">@if($currentWorkspace->city) {{$currentWorkspace->city}}, @endif @if($currentWorkspace->state){{$currentWorkspace->state}}@endif @if($currentWorkspace->zipcode)- {{$currentWorkspace->zipcode}}@endif</p>
                                        <p data-v-136bf9b5="">@if($currentWorkspace->country){{$currentWorkspace->country}}@endif</p>
                                        <p data-v-136bf9b5="">@if($currentWorkspace->telephone){{$currentWorkspace->telephone}}@endif</p>
                                    </div>
                                    <div data-v-136bf9b5="" class="col-33"><h1 data-v-136bf9b5="" class="fancy-title mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('INVOICE')}}</h1></div>
                                </div>
                                <div data-v-136bf9b5="" class="break-50"></div>
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-66"><strong data-v-136bf9b5="" class="mb5">{{__('Bill To')}}:</strong>
                                        <p data-v-136bf9b5="">{{$invoice->client->name}}</p>
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            <tbody data-v-136bf9b5="">
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Number')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Project')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{$invoice->project->name}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                                <div data-v-136bf9b5="" class="break-25"></div>
                                <div data-v-136bf9b5="" class="d-table">
                                    <div data-v-136bf9b5="" class="d-table">
                                        <div data-v-136bf9b5="" class="d-table-tr">
                                            <div data-v-136bf9b5="" class="d-table-th w-2">{{__('#')}}</div>
                                            <div data-v-136bf9b5="" class="d-table-th w-17">{{__('Item')}}</div>
                                            <div data-v-136bf9b5="" class="d-table-th w-5 text-right">{{__('Totals')}}</div>
                                        </div>
                                        <div data-v-136bf9b5="" class="d-table-body">
                                            @if($items = $invoice->items)
                                                @foreach($items as $key => $item)
                                                    <div data-v-136bf9b5="" class="d-table-tr">
                                                        <div data-v-136bf9b5="" class="d-table-td w-2"><span>{{$key+1}}</span></div>
                                                        <div data-v-136bf9b5="" class="d-table-td w-17">
                                                            <pre data-v-136bf9b5="">{{$item->task->title}}</pre>
                                                        </div>
                                                        <div data-v-136bf9b5="" class="d-table-td w-5 text-right"><span data-v-136bf9b5="">{{$currentWorkspace->priceFormat($item->price*$item->qty)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                        <div data-v-136bf9b5="" class="d-table-footer">
                                            <div data-v-136bf9b5="" class="d-table-controls"></div>
                                            <div data-v-136bf9b5="" class="d-table-summary">
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{__('Sub Total')}}:</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getSubTotal())}}</div>
                                                </div>
                                                @if($invoice->discount)
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{__('Discount')}}:</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->discount)}}</div>
                                                </div>
                                                @endif
                                                @if($invoice->tax)
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTaxTotal())}}</div>
                                                </div>
                                                @endif
                                                <div data-v-136bf9b5="" class="d-table-summary-item">
                                                    <div data-v-136bf9b5="" class="d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-136bf9b5="" class="d-table-value">{{$currentWorkspace->priceFormat($invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
