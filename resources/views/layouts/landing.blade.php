            ...
            <div class="row top-bar">
                <div class="col-lg-6 col-md-6 left-part">
                    <ul>
                        <li>
                            <a href="#">
                                <img src="{{asset(Storage::url('logo/logo-white.png'))}}" class="landing-logo" alt="logo">
                            </a>
                        </li>
{{--                        <li>--}}
...
{{--                            <a href="{{route('register')}}" class="button">try our system</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="features-button col-lg-12"><a href="{{route('register')}}">TRY OUR SYSTEM</a></div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
