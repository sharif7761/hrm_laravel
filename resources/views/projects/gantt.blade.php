...
@section('multiple-action-button')
    <div class="btn-group mt-1 mr-2" id="change_view" role="group">
        <a href="{{route('projects.gantt',[$currentWorkspace->slug,$project->id,'Quarter Day'])}}" class="btn btn-xs btn-info @if($duration == 'Quarter Day')active @endif" data-value="Quarter Day">{{__('Quarter Day')}}</a>
        <a href="{{route('projects.gantt',[$currentWorkspace->slug,$project->id,'Half Day'])}}" class="btn btn-xs btn-info @if($duration == 'Half Day')active @endif" data-value="Half Day">{{__('Half Day')}}</a>
        <a href="{{route('projects.gantt',[$currentWorkspace->slug,$project->id,'Day'])}}" class="btn btn-xs btn-info @if($duration == 'Day')active @endif" data-value="Day">{{__('Day')}}</a>
        <a href="{{route('projects.gantt',[$currentWorkspace->slug,$project->id,'Week'])}}" class="btn btn-xs btn-info @if($duration == 'Week')active @endif" data-value="Week">{{__('Week')}}</a>
        <a href="{{route('projects.gantt',[$currentWorkspace->slug,$project->id,'Month'])}}" class="btn btn-xs btn-info @if($duration == 'Month')active @endif" data-value="Month">{{__('Month')}}</a>
    </div>
    @auth('client')
