...
class Invoice extends Model
{
    ...
    public function pdf($currentWorkspace)
    {
        ...
        $quotation_note = '';
        $items = $this->items;
        $invoice = new InvoicePrinter("A4", ((!empty($currentWorkspace->currency)) ? $currentWorkspace->currency : 'TK'), $currentWorkspace->lang);

        $invoice->setLogo(env('APP_URL').Storage::url('logo/logo-blue.png'));
