                    ...
                    <div class="preview-main client-preview">
                        <div data-v-f2a183a6="" class="d" id="boxes">
                            <div data-v-f2a183a6="" class="d-body">
                                <h1 class="pdf-title">Invoice of <?php echo e($currentWorkspace->name); ?></h1>
                                <table class="table">
                                    <thead>
                                    <tr>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <th scope="row"><?php echo e(Utility::invoiceNumberFormat($invoice->invoice_id)); ?></th>
    ...
    <script>
        ...
        $(window).on('load', function () {
            ...
            var opt = {
                ...
                filename: '<?php echo e($currentWorkspace->slug.'-invoice'.time()); ?>',
...
<?php /**PATH C:\xampp\htdocs\taskly\resources\views/reports/invoice-template1.blade.php ENDPATH**/ ?>