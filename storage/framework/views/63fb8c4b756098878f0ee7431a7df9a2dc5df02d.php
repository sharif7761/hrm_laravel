                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                <div data-v-37eeda86="" class="row">
                                    <div data-v-37eeda86="" class="col-2">
                                        <img
                                            src="<?php if($currentWorkspace->logo): ?><?php echo e(asset(Storage::url('logo/'.$currentWorkspace->logo))); ?><?php else: ?><?php echo e(asset(Storage::url('logo/logo-blue.png'))); ?><?php endif; ?>"
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5"
                                        ...
                                        <table data-v-37eeda86="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right"><?php echo e(Utility::invoiceNumberFormat($invoice->invoice_id)); ?></td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right"><?php echo e(Utility::dateFormat($invoice->issue_date)); ?></td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu"><?php echo e(__('Due Date')); ?>:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right"><?php echo e(Utility::dateFormat($invoice->due_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\taskly\resources\views/invoices/template2.blade.php ENDPATH**/ ?>