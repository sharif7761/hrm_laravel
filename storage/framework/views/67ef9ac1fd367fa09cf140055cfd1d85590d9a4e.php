                    ...
                    <div class="preview-main client-preview">
                        <div data-v-f2a183a6="" class="d" id="boxes">
                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        <div data-v-f2a183a6="" class="d-header-brand">
                                            <img src="<?php if($currentWorkspace->logo): ?><?php echo e(asset(Storage::url('logo/'.$currentWorkspace->logo))); ?><?php else: ?><?php echo e(asset(Storage::url('logo/logo-blue.png'))); ?><?php endif; ?>" style="max-width: 100px"/>
                                        </div>
                                        <div data-v-f2a183a6="" class="break-25"></div>
                                        <p data-v-f2a183a6=""><?php if($currentWorkspace->company): ?><?php echo e($currentWorkspace->company); ?><?php endif; ?></p>
                                        <p>
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(Utility::invoiceNumberFormat($invoice->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Project')); ?>:</td>
                            ...
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to"><strong data-v-f2a183a6=""><?php echo e(__('Bill To')); ?>:</strong>
                                                ...
                                                <?php if($items = $invoice->items): ?>
                                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e(($color == '#ffffff') ? 'black' : $color); ?>;">
                                                            ...
                                                            <div class="d-table-td w-5 text-right"><span><?php echo e($currentWorkspace->priceFormat($item->price*$item->qty)); ?></span></div>
                                                        </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($currentWorkspace->priceFormat($invoice->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($invoice->discount): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">- <?php echo e($currentWorkspace->priceFormat($invoice->discount)); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if($invoice->tax): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e($invoice->tax->name); ?> (<?php echo e($invoice->tax->rate); ?>%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e($currentWorkspace->priceFormat($invoice->getTaxTotal())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e(($color == '#ffffff') ? 'black' : $color); ?>; border-bottom: 1px solid <?php echo e(($color == '#ffffff') ? 'black' : $color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($currentWorkspace->priceFormat($invoice->getTotal())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\taskly\resources\views/invoices/template1.blade.php ENDPATH**/ ?>